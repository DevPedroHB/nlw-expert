...
-- CreateIndex
CREATE UNIQUE INDEX "votes_poll_id_key" ON "votes"("poll_id");

-- CreateIndex
CREATE INDEX "votes_session_id_poll_id_poll_option_id_idx" ON "votes"("session_id", "poll_id", "poll_option_id");
